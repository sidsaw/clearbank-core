...
#   4. Snapshots coverage.md output to .demo/baseline_coverage.md
...
if [ -f coverage.md ]; then
    cp coverage.md "$DEMO_DIR/baseline_coverage.md"
    info "Saved baseline coverage to $DEMO_DIR/baseline_coverage.md"
else
    warn "coverage.md was not generated — saving empty baseline."
